...
| ![Walking the city](docs/images/city-walk.png) | **Walk and fly** at street level past lit doorways, passing traffic, streetlights, bins, benches and trees, with signs on every wall, folder street signs on the corners, source code on the facade in front of you, wandering residents and a city wall covered in posters. |
